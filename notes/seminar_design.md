...
- **Amateur Radio textbook anecdote (charter, personal experiences #4).** Excellent illustration of "AI transforms a curated source corpus into a new structured artifact," but it's not an academic-research example, and the talk already has strong candidate stories from real research (see [demo_ideas.md](demo_ideas.md)). Resolved (2026-09-02, revised same day): rather than a mid-talk aside, it now anchors a new one-minute closing Section 9, "Unleash Your Curiosity: AI and your hobbies" — a deliberate, lighter human beat before Q&A, paired with a pending 3D-printing example. Keeps it out of the research-lifecycle narrative entirely rather than interrupting Section 3.

...
- **Writing-style guide source material** — still pending. Alex confirmed he'll send the prior style-analysis file; `resources/style/alex_dowling_writing_style.md` stays blocked until it arrives.

...
| 7 | Task 6 — from an inherited project to a draft manuscript | Type 1, generic — continues the membrane-transport project from Act I's Task 2 | Context reconstructed, computation baselined, now the results become a paper | `scientific_computing_workflow.md` (callback) |
| 8 | Task 6 — draft against a structure, in a stated voice | Type 1, same | Structure and voice: both stated, neither assumed | `technical_writing.md`, `writing_style_guide.md` |
| 9 | Task 6 — figures that trace back, an audit before anyone else's | Type 1, same | The loop closes on itself — the project audits its own paper | `scientific_figures_tables.md`, `resources/templates/results_manifest.md` |

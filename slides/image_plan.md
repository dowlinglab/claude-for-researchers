...
Revised September 14, 2026 after Alex's annotated read-through. Slide numbers follow the current
53-slide [storyboard](storyboard.md). Earlier plans remain in Git history. Earlier capture plans remain in Git history through `2c55c74`. Screenshots are evidence and interface examples, not decorative images.

## Assets used in the 53-slide deck
...
| 22 | `bits_for_gaps_graphical_abstract.png` | Published software case study; existing asset |
| 27 | `overleaf_github_sync.png` | Explicit push/pull dialog; [Overleaf GitHub synchronization documentation](https://docs.overleaf.com/integrations-and-add-ons/git-integration-and-github-synchronization/github-synchronization), accessed September 11. Exported the rendered page's `Github_modal.png` asset; converted AVIF to PNG without changing its content. |
| 32 | `github_desktop_diff.png` | Source-file diff; [official documentation](https://docs.github.com/en/desktop/making-changes-in-a-branch/committing-and-reviewing-changes-to-your-project-in-github-desktop), [original image](https://docs.github.com/assets/cb-66158/images/help/desktop/diff-selection.png), accessed September 11 |
| 32 | `manuscript_diff.pdf` | Actual compiled `latexdiff` output from the [illustrative source pair](../resources/examples/manuscript_revision/README.md); not research results |
| 41 | `coursepack_sources.png`, `coursepack_gap.png` | Existing working-tree coursepack excerpts: source cross-references and a student activity gap; cropped in LaTeX, original images preserved |
| 51 | `kitchen_organizer_telescope_shelf.jpeg` | AI-assisted hobby design examples; existing asset |
| 52 | `filter_families.pdf` | Reproducible figure from the personalized textbook; existing asset |
...
generator is `figures/august_2026_calendar_source/make_calendar.py`. August 17 is when the course
sprint began and August 24 was the first lecture, per `org/calendar.md` in the public repository.

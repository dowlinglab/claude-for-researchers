...
\begin{frame}{The six tasks form one research workflow}
  ...
  \begin{tabular}{@{}lccccc@{}}
    ...
    Task 3 --- idea $\to$ report or proposal & & & \good{} & \\
...
\begin{frame}[fragile]{Getting started later today}
  ...
  \begin{enumerate}\small\setlength\itemsep{0.5em}
    \item Create \textbf{Claude and GitHub accounts}; install \textbf{GitHub Desktop} and \textbf{Claude or ChatGPT}.
    \item Clone this public repo with \textbf{GitHub Desktop}.
    \item Open the folder in \textbf{Codex or Claude Code}.
    \item Paste this prompt and inspect the evidence it returns.
  \end{enumerate}
  \vspace{0.4em}
...
Do not edit anything yet.
  \end{lstlisting}
  \begin{center}\small
    Then use \href{https://github.com/dowlinglab/claude-for-researchers/blob/main/resources/prompts/getting_started.md}{\texttt{resources/prompts/getting\_started.md}} to choose a task for your own project.
  \end{center}

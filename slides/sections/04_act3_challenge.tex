...
\begin{frame}{Task 4: Audit a manuscript before submission}
  ...
  {\small
    ...
    \begin{itemize}\small\setlength\itemsep{0.1em}
      \item The manuscript and analysis are under version control.
      \item The computational environment runs.
      \item The literature corpus from Task 3 is available to the agent.
    \end{itemize}
  }
  \vspace{0.5em}
...
\begin{frame}{The DOI checker has two verification modes}
  ...
  \begin{tikzpicture}[font=\small,
      doi mode/.style={draw=NDBlue, rounded corners=2pt, text width=4.0cm,
        minimum height=1.5cm, inner sep=0.1cm, align=center}]
    \node[draw=NDBlue, rounded corners=2pt, text width=2.2cm,
    ...
    \node[draw=NDGold, rounded corners=2pt, text width=3.4cm,
      minimum height=1.5cm, align=center, fill=CodeBg] (d) at (10,0)

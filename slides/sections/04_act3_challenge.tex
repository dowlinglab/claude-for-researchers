...
\begin{frame}{Task 5: Draft a manuscript from the previous tasks}
  ...
  \vfill
  \begin{center}
  \begin{tikzpicture}[font=\scriptsize, node distance=0.30cm,
      task box/.style={draw=NDBlue, rounded corners=2pt, minimum height=0.68cm,
        inner xsep=0.18cm, align=center, fill=black!2}]
    \node[task box]
    ...
    \node[task box, draw=NDGold, minimum height=0.76cm, below=0.38cm of d, fill=CodeBg]

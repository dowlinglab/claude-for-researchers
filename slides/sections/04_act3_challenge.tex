...
\begin{frame}{Task 5: Figures first, then outline, sections, and revision}
  ...
  \begin{tikzpicture}[font=\small, node distance=0.75cm]
    \node[nd box, minimum width=2.7cm, minimum height=1.3cm, align=center]
      (a) {Develop the\\key figures};
    \node[nd box, minimum width=2.7cm, minimum height=1.3cm, align=center, right=of a]
      (b) {Outline claims\\around figures};
    \node[nd box, minimum width=2.7cm, minimum height=1.3cm, align=center, right=of b]
      (c) {Draft one\\section at a time};
    \node[nd box, minimum width=2.7cm, minimum height=1.3cm, align=center, right=of c]
      (d) {Edit against corpus\\and style guide};
    \node[nd highlight, minimum width=2.7cm, minimum height=1.3cm, align=center, right=of d]

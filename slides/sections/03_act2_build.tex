...
\begin{frame}{Task 3, step 3: Edit the document against the curated corpus}
  ...
  \begin{tikzpicture}[font=\small, node distance=0.85cm]
    \node[nd box, minimum width=2.8cm, minimum height=1.2cm, align=center]
      (a) {Question +\\\texttt{literature.md}};
    \node[nd box, minimum width=2.8cm, minimum height=1.2cm, align=center, right=of a]
      (b) {Claim and evidence\\outline};
    \node[nd box, minimum width=2.8cm, minimum height=1.2cm, align=center, right=of b]
      (c) {Draft one\\section at a time};
    \node[nd highlight, minimum width=3.0cm, minimum height=1.2cm, align=center, right=of c]

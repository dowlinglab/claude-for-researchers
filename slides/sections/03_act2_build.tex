...
\begin{frame}{Task 4 --- the recipe, final paper code $\to$ generalized, published package}
  ...
  % TODO: Help me reduce the white space at the top of the slide
  \begin{center}
...
% reproducing the manual's own enumerated lists verbatim. Not linked
% publicly (the manual itself is lab-internal, not a public resource of
% this repo) -- the practice is what's shared, not the document.

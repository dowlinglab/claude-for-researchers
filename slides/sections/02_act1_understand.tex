  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.46\textwidth}
      ...
      \begin{itemize}\small
        ...
        \item survives tools, people, and time
      \end{itemize}
    \end{column}
  \end{columns}
  \vspace{0.7em}
...
\begin{frame}{Task 3 --- idea first: brainstorm, refine, then bring in the literature}
  \ndlogonote{\scriptsize\href{https://github.com/dowlinglab/claude-for-researchers/blob/main/resources/practices/literature_review.md}{\texttt{literature\_review.md}} + \href{https://github.com/dowlinglab/claude-for-researchers/blob/main/resources/prompts/literature_workflow.md}{\texttt{literature\_workflow.md}}\\\href{https://github.com/dowlinglab/claude-for-researchers/blob/main/resources/practices/grant_proposal_writing.md}{\texttt{grant\_proposal\_writing.md}}}
  \vfill
  \begin{center}

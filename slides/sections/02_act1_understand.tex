...
\begin{frame}{Task 2 --- a chat history can't hold any of these three}
  ...
  \begin{columns}[t]
    \begin{column}{0.31\textwidth}
      ...
      Your data and results don't change between sessions. \\ A changing number could be a finding or bug. \\[0.7em]

    \end{column}
    \begin{column}{0.31\textwidth}
      {\color{NDBlue}\textbf{Authoritative}}\\[0.4em]
      The actual code and data. \\[0.2em] {\footnotesize Point an agent at the real files under (version control!); never describe them from memory.}\\[0.7em]
    \end{column}
    \begin{column}{0.31\textwidth}
      {\color{NDBlue}\textbf{Task}}\\[0.4em]
      What you're working on right now, defined fresh each session.\\[0.2em]
